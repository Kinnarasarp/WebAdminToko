...
@section('content')
  ...
  <div class="row mx-1" style="display: flex; justify-content: space-between;">
    <div class="col-6 card shadow-none bg-transparent border border-primary" style="width: 50%;">
      <div class="card-body">
        <h5 class="card-title">Toko Berkah</h5>
        <p class="card-text">Jl. Ketintang no.109, Surabaya, Jawa Timur, Indonesia</p>
        <p class="card-text">Whatsapp : 082143022175</p>
        <p class="card-text">Instagram : @tokoberkahsby</p>
      </div>
    </div>
    <div class="col-6">
      <div class="row h-100">
